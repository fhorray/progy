/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: bd8d3005eb2227b4c953b24ccb4b2e8d)
...
declare namespace Cloudflare {
    ...
    interface Env {
        ...
        STRIPE_PRICE_ID_LIFETIME: "price_1SyBy8GdycZGJETWNQ2HCROC";
        COURSE_GUARD: Workflow<Parameters<import("./src/index").CourseGuardWorkflow['run']>[0]['payload']>;
        TUTOR_AGENT: Workflow<Parameters<import("./src/index").TutorAgentWorkflow['run']>[0]['payload']>;
        AGGREGATION: Workflow<Parameters<import("./src/index").AggregationWorkflow['run']>[0]['payload']>;
        ENVIRONMENT: string;
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "PROGY_API_URL" | "STRIPE_PRICE_ID_PRO" | "STRIPE_PRICE_ID_LIFETIME" | "COURSES">> { }
}
