...
const fsGetHandler: ServerType<"/instructor/fs"> = async (req: Request) => {
...
const fsWriteHandler: ServerType<"/instructor/fs"> = async (req: Request) => {
  const blocked = guardEditor();
  if (blocked) return blocked;
...
const fsDeleteHandler: ServerType<"/instructor/fs"> = async (req: Request) => {
  const blocked = guardEditor();
  if (blocked) return blocked;
...
const fsMoveHandler: ServerType<"/instructor/fs"> = async (req: Request) => {
  const blocked = guardEditor();
  if (blocked) return blocked;
...
const instructorConfigPost: ServerType<"/instructor/config"> = async (req: Request) => {
  const blocked = guardEditor();
  if (blocked) return blocked;
...
const scaffoldHandler: ServerType<"/instructor/scaffold"> = async (req: Request) => {
  const blocked = guardEditor();
  if (blocked) return blocked;
...
const uploadHandler: ServerType<"/instructor/upload"> = async (req: Request) => {
  const blocked = guardEditor();
  if (blocked) return blocked;
...
const reorderHandler: ServerType<"/instructor/reorder"> = async (req: Request) => {
  const blocked = guardEditor();
  if (blocked) return blocked;
...
const runHandler: ServerType<"/instructor/run"> = async (req: Request) => {
  const blocked = guardEditor();
  if (blocked) return blocked;
