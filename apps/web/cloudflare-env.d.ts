/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: a6492aac20fd426e30623913e957ec54)
// Runtime types generated with workerd@1.20260205.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ASSETS: Fetcher;
		NEXT_PUBLIC_API_URL: "https://progy.francy.workers.dev";
		NEXTJS_ENV: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_API_URL" | "NEXTJS_ENV">> {}
}
